...
public class ToolRegistryEdgeTests
{
    ...
    public void CreateDefault_RegistersExpectedToolSet()
    {
        ...
        Assert.Equal(
            new[] { "apply_patch", "bash", "compare_files", "edit_file", "glob", "grep", "list_directory", "powershell", "project_stats", "read_file", "read_files", "run_command", "session_search", "stop", "write_file" },
            names);
    }
}
