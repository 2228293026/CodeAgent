...
public class ToolRegistryEdgeTests
{
    ...
    public void CreateDefault_RegistersExpectedToolSet()
    {
        ...
        Assert.Equal(
            new[] { "apply_patch", "bash", "checksum_manifest", "compare_directories", "compare_files", "copy_file", "copy_files", "delete_file", "delete_files", "edit_file", "encoding_report", "file_info", "file_infos", "find_duplicates", "find_empty_directories", "find_large_files", "find_symlinks", "git_blame", "git_branches", "git_diff", "git_log", "git_reflog", "git_remotes", "git_show", "git_stashes", "git_status", "git_tags", "git_worktrees", "glob", "grep", "list_directory", "move_file", "move_files", "powershell", "project_stats", "read_file", "read_files", "replace_in_files", "run_command", "session_search", "stop", "write_file" },
            names);
    }
}
