...
public class ToolRegistryEdgeTests
{
    ...
    public void CreateDefault_RegistersExpectedToolSet()
    {
        ...
        Assert.Equal(
            new[] { "apply_patch", "backup_file", "bash", "checksum_manifest", "compare_directories", "compare_files", "copy_file", "copy_files", "create_directory", "delete_file", "delete_files", "directory_depth_report", "directory_size_breakdown", "directory_size_report", "edit_file", "encoding_report", "file_extension_report", "file_info", "file_infos", "find_duplicates", "find_empty_directories", "find_empty_files", "find_filename_conflicts", "find_large_files", "find_long_paths", "find_recent_files", "find_stale_files", "find_symlinks", "find_temporary_files", "find_unreadable_files", "git_blame", "git_branches", "git_check_attr", "git_check_ignore", "git_commit_info", "git_compare_refs", "git_contributors", "git_describe", "git_diff", "git_file_history", "git_file_stats", "git_fsck", "git_ignored_files", "git_index_diagnostics", "git_log", "git_ls_files", "git_object_info", "git_path_diff", "git_reflog", "git_remotes", "git_repository_info", "git_show", "git_stashes", "git_status", "git_submodule_status", "git_tag_info", "git_tags", "git_tree_entries", "git_worktree_details", "git_worktrees", "glob", "grep", "line_ending_report", "list_directory", "move_file", "move_files", "normalize_line_endings", "powershell", "project_stats", "read_file", "read_files", "remove_empty_directory", "replace_in_files", "restore_backup", "run_command", "session_search", "stop", "write_file" },
            names);
    }
}
