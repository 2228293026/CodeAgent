...
public class ToolRegistryEdgeTests
{
    ...
    public void CreateDefault_RegistersExpectedToolSet()
    {
        ...
        Assert.Equal(
            new[] { "api_compatibility_report", "api_usage_report", "api_version_pin_report", "apply_patch", "argument_safety_report", "array_bounds_report", "async_correctness_report", "async_misuse_report", "backup_file", "bash", "boolean_parameter_report", "boxing_allocation_report", "build_config_report", "cache_strategy_report", "changelog_report", "checksum_manifest", "ci_workflow_report", "code_metrics_report", "code_style_report", "collection_edge_report", "collection_performance_report", "collection_usage_report", "comment_quality_report", "compare_directories", "compare_files", "concurrency_risk_report", "concurrency_safety_report", "concurrent_mutation_report", "config_hardening_report", "config_key_report", "config_key_usage_report", "config_robustness_report", "contract_evolution_report", "copy_file", "copy_files", "create_directory", "csharp_keyword_report", "culture_format_report", "data_contract_report", "dead_branch_report", "dead_implementation_report", "debug_leftover_report", "default_parameter_report", "deferred_query_report", "delete_file", "delete_files", "dependency_inversion_report", "dependency_lockfile_report", "dependency_version_report", "directory_depth_report", "directory_size_breakdown", "directory_size_report", "disposable_pattern_report", "doc_comment_report", "doc_freshness_report", "documentation_sync_report", "duplicate_code_report", "duplicate_logic_report", "duplicate_method_report", "edit_file", "editorconfig_report", "encoding_report", "enum_flag_report", "enum_usage_report", "env_var_reference_report", "equality_contract_report", "equals_gethashcode_report", "error_handling_detail_report", "event_subscription_report", "exception_handling_report", "expensive_call_report", "extension_method_report", "file_extension_report", "file_info", "file_infos", "file_safety_report", "find_duplicates", "find_empty_directories", "find_empty_files", "find_filename_conflicts", "find_large_files", "find_long_paths", "find_recent_files", "find_stale_files", "find_symlinks", "find_temporary_files", "find_unreadable_files", "float_precision_report", "git_blame", "git_branch_age_report", "git_branches", "git_check_attr", "git_check_ignore", "git_commit_info", "git_compare_refs", "git_config_report", "git_contributors", "git_describe", "git_diff", "git_executable_bit_report", "git_file_history", "git_file_stats", "git_file_type_report", "git_fsck", "git_gpg_status_report", "git_hook_inventory", "git_ignored_files", "git_index_diagnostics", "git_lfs_report", "git_log", "git_ls_files", "git_object_info", "git_path_diff", "git_reflog", "git_remote_sync_report", "git_remotes", "git_repo_size_report", "git_repository_info", "git_show", "git_stash_info", "git_stashes", "git_status", "git_submodule_status", "git_tag_info", "git_tags", "git_tree_entries", "git_worktree_details", "git_worktrees", "gitattributes_quality_report", "gitattributes_report", "gitignore_pattern_report", "gitignore_quality_report", "gitignore_rule_report", "glob", "grep", "hardcoded_secret_report", "http_url_audit_report", "i18n_string_report", "inheritance_shape_report", "input_sanitization_report", "input_validation_report", "integer_overflow_report", "interface_contract_report", "iterator_yield_report", "json_schema_report", "large_method_report", "license_inventory_report", "lifetime_bounds_report", "line_ending_mixed_report", "line_ending_report", "linq_deferred_report", "linq_query_report", "list_directory", "localization_readiness_report", "lock_misuse_report", "log_hygiene_report", "logging_practice_report", "lost_update_report", "magic_number_report", "move_file", "move_files", "naming_convention_report", "nested_try_report", "normalize_line_endings", "nuget_reference_report", "null_assignment_report", "null_coalescing_report", "null_safety_report", "nullable_annotation_report", "numeric_literal_report", "observability_gap_report", "observability_report", "obsolete_usage_report", "operator_overload_report", "optional_param_dropped_report", "ownership_report", "partial_method_report", "path_escape_report", "performance_anti_pattern_report", "powershell", "project_manifest_report", "project_stats", "public_api_surface_report", "read_file", "read_files", "readme_link_check", "readme_section_report", "readonly_struct_report", "record_mutability_report", "remove_empty_directory", "replace_in_files", "resource_leak_report", "resource_lifecycle_report", "restore_backup", "retry_safety_report", "run_command", "secret_scan_report", "sensitive_file_inventory", "session_search", "silent_catch_report", "source_composition_report", "stale_comment_report", "state_machine_report", "state_management_report", "stop", "string_concat_perf_report", "string_format_report", "string_interpolation_report", "string_performance_report", "swallowed_exception_report", "switch_exhaustiveness_report", "switch_fallthrough_report", "target_framework_report", "test_assertion_report", "test_flakiness_report", "test_inventory_report", "test_isolation_report", "test_placeholder_report", "test_quality_report", "testability_report", "time_unit_confusion_report", "time_zone_report", "todo_comment_report", "todo_marker_report", "undisposed_stream_report", "untrusted_input_report", "using_directive_report", "weak_assertion_report", "workflow_hygiene_report", "write_file" },
            names);
    }
}
