...
public class ToolRegistryEdgeTests
{
    ...
    public void CreateDefault_RegistersExpectedToolSet()
    {
        ...
        Assert.Equal(
            new[] { "apply_patch", "backup_file", "bash", "changelog_report", "checksum_manifest", "ci_workflow_report", "code_metrics_report", "compare_directories", "compare_files", "copy_file", "copy_files", "create_directory", "delete_file", "delete_files", "dependency_lockfile_report", "directory_depth_report", "directory_size_breakdown", "directory_size_report", "edit_file", "encoding_report", "env_var_reference_report", "file_extension_report", "file_info", "file_infos", "find_duplicates", "find_empty_directories", "find_empty_files", "find_filename_conflicts", "find_large_files", "find_long_paths", "find_recent_files", "find_stale_files", "find_symlinks", "find_temporary_files", "find_unreadable_files", "git_blame", "git_branches", "git_check_attr", "git_check_ignore", "git_commit_info", "git_compare_refs", "git_config_report", "git_contributors", "git_describe", "git_diff", "git_executable_bit_report", "git_file_history", "git_file_stats", "git_fsck", "git_gpg_status_report", "git_hook_inventory", "git_ignored_files", "git_index_diagnostics", "git_lfs_report", "git_log", "git_ls_files", "git_object_info", "git_path_diff", "git_reflog", "git_remotes", "git_repository_info", "git_show", "git_stash_info", "git_stashes", "git_status", "git_submodule_status", "git_tag_info", "git_tags", "git_tree_entries", "git_worktree_details", "git_worktrees", "gitattributes_report", "gitignore_pattern_report", "glob", "grep", "http_url_audit_report", "i18n_string_report", "json_schema_report", "license_inventory_report", "line_ending_report", "list_directory", "move_file", "move_files", "normalize_line_endings", "powershell", "project_manifest_report", "project_stats", "read_file", "read_files", "readme_link_check", "readme_section_report", "remove_empty_directory", "replace_in_files", "restore_backup", "run_command", "secret_scan_report", "sensitive_file_inventory", "session_search", "stop", "test_inventory_report", "todo_marker_report", "write_file" },
            names);
    }
}
