...
public class ToolRegistryEdgeTests
{
    ...
    public void CreateDefault_RegistersExpectedToolSet()
    {
        ...
        Assert.Equal(
            new[] { "apply_patch", "backup_file", "bash", "checksum_manifest", "compare_directories", "compare_files", "copy_file", "copy_files", "create_directory", "delete_file", "delete_files", "directory_size_report", "edit_file", "encoding_report", "file_info", "file_infos", "find_duplicates", "find_empty_directories", "find_empty_files", "find_large_files", "find_recent_files", "find_stale_files", "find_symlinks", "find_temporary_files", "find_unreadable_files", "git_blame", "git_branches", "git_diff", "git_log", "git_reflog", "git_remotes", "git_show", "git_stashes", "git_status", "git_tags", "git_worktrees", "glob", "grep", "list_directory", "move_file", "move_files", "normalize_line_endings", "powershell", "project_stats", "read_file", "read_files", "remove_empty_directory", "replace_in_files", "restore_backup", "run_command", "session_search", "stop", "write_file" },
            names);
    }
}
