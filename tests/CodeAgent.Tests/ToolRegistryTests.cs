...
public class ToolRegistryTests : IDisposable
{
    ...
    [Fact]
    public void CreateDefault_RegistersAllThirtyTools()
    {
        ...
        var expected = new[]
        {
            "read_file", "read_files", "compare_files", "project_stats", "file_info", "replace_in_files", "copy_file", "copy_files", "move_file", "delete_file", "find_duplicates", "git_status", "git_diff", "git_log", "git_blame", "git_show", "git_branches", "git_remotes", "git_tags", "write_file", "edit_file", "list_directory",
