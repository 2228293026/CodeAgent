...
public class ToolRegistryTests : IDisposable
{
    ...
    [Fact]
    public void CreateDefault_RegistersOneHundredSeventyFiveTools()
    {
        ...
        Assert.Equal(175, expected.Length); // 不应有多余工具
