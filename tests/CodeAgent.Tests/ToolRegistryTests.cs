...
public class ToolRegistryTests : IDisposable
{
    ...
    [Fact]
    public void CreateDefault_RegistersAllFortyFourTools()
    {
        ...
        var expected = new[]
        {
            "read_file", "read_files", "compare_files", "compare_directories", "project_stats", "file_info", "file_infos", "replace_in_files", "copy_file", "copy_files", "move_file", "move_files", "delete_file", "delete_files", "find_duplicates", "find_large_files", "find_empty_directories", "find_symlinks", "checksum_manifest", "encoding_report", "normalize_line_endings", "create_directory", "git_status", "git_diff", "git_log", "git_blame", "git_show", "git_branches", "git_remotes", "git_tags", "git_reflog", "git_worktrees", "git_stashes", "write_file", "edit_file", "list_directory",
