...
public class ToolRegistryTests : IDisposable
{
    ...
    [Fact]
    public void CreateDefault_RegistersTwoHundredTwelveTools()
    {
        ...
        Assert.Equal(212, expected.Length); // 不应有多余工具
