...
public class ToolRegistryTests : IDisposable
{
    ...
    [Fact]
    public void CreateDefault_RegistersOneHundredSixtyFourTools()
    {
        ...
        var expected = new[]
        {
            "read_file", "read_files", "compare_files", "compare_directories", "project_stats", "code_metrics_report", "code_style_report", "comment_quality_report", "config_hardening_report", "source_composition_report", "directory_size_report", "file_info", "file_infos", "replace_in_files", "copy_file", "copy_files", "move_file", "move_files", "delete_file", "delete_files", "find_duplicates", "find_large_files", "find_stale_files", "find_unreadable_files", "find_temporary_files", "backup_file", "restore_backup", "find_empty_files", "find_recent_files", "find_filename_conflicts", "find_long_paths", "find_empty_directories", "find_symlinks", "checksum_manifest", "encoding_report", "normalize_line_endings", "create_directory", "remove_empty_directory", "git_status", "git_check_ignore", "git_check_attr", "git_ls_files", "git_repository_info", "git_repo_size_report", "git_fsck", "git_submodule_status", "git_describe", "git_contributors", "git_file_history", "git_file_stats", "git_object_info", "git_tree_entries", "git_commit_info", "git_compare_refs", "git_tag_info", "file_extension_report", "git_file_type_report", "line_ending_report", "directory_depth_report", "directory_size_breakdown", "project_manifest_report", "target_framework_report", "config_key_report", "readme_section_report", "changelog_report", "i18n_string_report", "inheritance_shape_report", "readme_link_check", "doc_freshness_report", "http_url_audit_report", "test_inventory_report", "test_flakiness_report", "test_assertion_report", "debug_leftover_report", "exception_handling_report", "resource_leak_report", "naming_convention_report", "todo_marker_report", "ci_workflow_report", "workflow_hygiene_report", "license_inventory_report", "dependency_lockfile_report", "nuget_reference_report", "json_schema_report", "secret_scan_report", "env_var_reference_report", "sensitive_file_inventory", "gitignore_pattern_report", "gitignore_rule_report", "editorconfig_report", "gitattributes_report", "git_hook_inventory", "git_executable_bit_report", "git_config_report", "git_lfs_report", "git_gpg_status_report", "git_ignored_files", "git_path_diff", "git_index_diagnostics", "git_worktree_details", "git_stash_info", "git_diff", "git_log", "git_blame", "git_show", "git_branches", "git_branch_age_report", "git_remotes", "git_remote_sync_report", "git_tags", "git_reflog", "git_worktrees", "git_stashes", "write_file", "edit_file", "list_directory",
            "glob", "grep", "run_command", "bash", "powershell",
            "session_search", "stop", "apply_patch", "async_correctness_report", "string_performance_report", "null_coalescing_report", "null_safety_report", "logging_practice_report", "api_usage_report", "api_compatibility_report", "data_contract_report", "performance_anti_pattern_report", "test_quality_report", "resource_lifecycle_report", "localization_readiness_report", "disposable_pattern_report", "documentation_sync_report", "input_sanitization_report", "observability_report", "build_config_report", "cache_strategy_report", "concurrency_safety_report", "collection_usage_report", "expensive_call_report", "state_management_report", "string_format_report", "log_hygiene_report", "file_safety_report", "dependency_version_report", "equality_contract_report", "error_handling_detail_report", "event_subscription_report", "collection_performance_report", "concurrency_risk_report", "dead_implementation_report", "input_validation_report", "argument_safety_report", "duplicate_code_report", "dead_branch_report", "lifetime_bounds_report", "numeric_literal_report", "test_isolation_report", "using_directive_report",
        };
        foreach (var name in expected)
            Assert.True(names.Contains(name), $"缺少工具: {name}");
        Assert.Equal(164, expected.Length); // 不应有多余工具
